...
SET PartitionTableGlobal = 'DSVLigneTicket',
PartitionTableUnitaire = 'DSVLigneTicket'
...
UPDATE DSV.Partitions 
SET PartitionTableGlobal = 'DSVStockMagasin',
PartitionTableUnitaire = 'DSVStockMagasin'
...
UPDATE DSV.Partitions 
SET PartitionTableGlobal = 'dbo.DSVDebitGroupeCRM',
PartitionTableUnitaire = 'DSVDebitGroupeCRM'
...
UPDATE DSV.Partitions 
SET PartitionTableGlobal = 'dbo.DSVRemun',
PartitionTableUnitaire = 'DSVRemun'
...
UPDATE DSV.Partitions 
SET PartitionTableGlobal = 'dbo.DSVStock',
PartitionTableUnitaire = 'DSVStock'
...
UPDATE DSV.Partitions 
SET PartitionTableGlobal = 'dbo.DSVFactures',
PartitionTableUnitaire = 'DSVFactures'
...
UPDATE DSV.Partitions 
SET PartitionTableGlobal = 'dbo.DSVTicketCRM',
PartitionTableUnitaire = 'DSVTicketCRM'
...
UPDATE DSV.Partitions 
SET PartitionTableGlobal = '[dbo].[DSVDebitFamille]',
PartitionTableUnitaire = 'DSVDebitFamille'
WHERE PartitionTableQuery = 'SELECT [dbo].[DSVDebitFamille].[FamilleArticle_id],[dbo].[DSVDebitFamille].[Debit],[dbo].[DSVDebitFamille].[Societe_id],[dbo].[DSVDebitFamille].[TypeDebit_id],[dbo].[DSVDebitFamille].[Temps_id],[dbo].[DSVDebitFamille].[campagne_id],[dbo].[DSVDebitFamille].[DebitOpeCo] FROM [dbo].[DSVDebitFamille]'

UPDATE DSV.Partitions 
SET PartitionTableGlobal = '[dbo].[DSVDebitGroupe]',
PartitionTableUnitaire = 'DSVDebitGroupe'
WHERE PartitionTableQuery = 'SELECT [dbo].[DSVDebitGroupe].[GroupeArticle_id],[dbo].[DSVDebitGroupe].[Debit],[dbo].[DSVDebitGroupe].[Temps_id],[dbo].[DSVDebitGroupe].[Societe_id],[dbo].[DSVDebitGroupe].[TypeDebit_id],[dbo].[DSVDebitGroupe].[campagne_id],[dbo].[DSVDebitGroupe].[DebitOpeCo] FROM [dbo].[DSVDebitGroupe]'

UPDATE DSV.Partitions 
SET PartitionTableGlobal = '[dbo].[DSVDebitSousFamille]',
PartitionTableUnitaire = 'DSVDebitSousFamille'
...
UPDATE DSV.Partitions 
SET PartitionTableGlobal = '[dbo].[DSVDebitSousGroupe]',
PartitionTableUnitaire = 'DSVDebitSousGroupe'
...
UPDATE DSV.Partitions 
SET PartitionTableGlobal = '[dbo].[DSVDebitTotaux]',
PartitionTableUnitaire = 'DSVDebitTotaux'
WHERE PartitionTableQuery = 'SELECT [dbo].[DSVDebitTotaux].[Debit],[dbo].[DSVDebitTotaux].[Temps_id],[dbo].[DSVDebitTotaux].[Societe_id],[dbo].[DSVDebitTotaux].[TypeDebit_id],[dbo].[DSVDebitTotaux].[campagne_id],[dbo].[DSVDebitTotaux].[DebitOpeCo] FROM [dbo].[DSVDebitTotaux]'

UPDATE DSV.Partitions 
SET PartitionTableGlobal = '[dbo].[DSVDebitUnivers]',
PartitionTableUnitaire = 'DSVDebitUnivers'
WHERE PartitionTableQuery = 'SELECT [dbo].[DSVDebitUnivers].[Debit],[dbo].[DSVDebitUnivers].[Temps_id],[dbo].[DSVDebitUnivers].[Societe_id],[dbo].[DSVDebitUnivers].[TypeDebit_id],[dbo].[DSVDebitUnivers].[campagne_id],[dbo].[DSVDebitUnivers].[DebitOpeCo],[dbo].[DSVDebitUnivers].[UniversArticle_id] FROM [dbo].[DSVDebitUnivers]'

UPDATE DSV.Partitions 
SET PartitionTableGlobal = '[dbo].[DSVSoldePoints]',
PartitionTableUnitaire = 'DSVSoldePoints'
